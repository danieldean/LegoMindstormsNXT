...
/* A basic robot that drives, detects an object, and then reverses
 * and changes direction.
 *
 * Ideally the robots length needs to be less than or the same
 * as its width otherwise room corners can pose an issue.
 */
public class SensorBot implements FeatureListener, Runnable {
    ...
    /* Distance from object before detection.
     * In centimetres.
     */
    private final static int DETECTION_DISTANCE = 10;
    ...
    private int detectionDistance = 0;
    ...
    public static void main(String[] args) {
        ...
        SensorBot bb = new SensorBot(ROBOT_WIDTH, TYRE_DIAMETER, TYRE_WIDTH, DETECTION_DISTANCE);
    ...
    public SensorBot(double robotWidth, double tyreDiameter, double tyreWidth, int detectionDistance) {
        ...
        RangeFeatureDetector fd = new RangeFeatureDetector(us, 40, 250);
        fd.addListener(this);
    ...
    public void featureDetected(Feature feature, FeatureDetector detector) {
        ...
        if(feature.getRangeReading().getRange() < detectionDistance) {
